...
@section('content')
    ...
    <a href="{{ route('lowongan.create') }}" class="btn btn-primary mb-3">+ Buat Lowongan Baru</a>
            ...
            <tbody>
                @foreach ($lowongan as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('lowongan.show', $item->id) }}">Lihat</a> |
                            <a href="{{ route('lowongan.edit', $item->id) }}">Edit</a> |
